...
def create_app():
    ...
    # 2. Create StringVariables to hold the text
    start_var = tk.StringVar(value="2") # Default value
    end_var = tk.StringVar(value="100") # Default value
